...
namespace ScreenSaverEngine2.Scenes.SceneHelpers.Particles
{
    public class ParticleSystemSelector : Component, IUpdatable
    {
        ...
        private void MakeSlider(Table table, Skin skin, string label, float min, float max, float step, string propertyName)
        {
        ...
        private void MakeBlendDropdown(Table table, Skin skin, string label, string propertyName)
        {
            FieldInfo fieldInfo = typeof(ParticleEmitterConfig).GetField(propertyName);
        ...
        private void MakeEmitterDropdown(Table table, Skin skin, string label)
        {
        ...
        private void MakeVector2(Table table, Skin skin, string label, string propertyName)
        {
        ...
        private void MakeColor(Table table, Skin skin, string label, string propertyName)
        {
            FieldInfo fieldInfo = typeof(ParticleEmitterConfig).GetField(propertyName);
        ...
        private void MakeSection(Table table, Skin skin, string sectionName)
        {
        ...
        private void CondenseSkin(Skin skin)
        {
        ...
        private void ExportPexClicked(Skin skin)
        {
