...
namespace ScreenSaverEngine2.Scenes.SceneHelpers.Particles
{
    public class PexExporter
    {
        ...
        private void AddXmlChild(XmlDocument doc, XmlElement parent, string elementName, float value, string formatString = "F")
        {
            AddXmlChild(doc, parent, elementName, value.ToString(formatString));
        }

        private void AddXmlChild(XmlDocument doc, XmlElement parent, string elementName, string value)
        {
        ...
        private void AddXmlChild(XmlDocument doc, XmlElement parent, string elementName, Vector2 coordinate)
        {
            var attrs = new Dictionary<string, string>();
        ...
        private void AddXmlChild(XmlDocument doc, XmlElement parent, string elementName, Color color)
        {
            var attrs = new Dictionary<string, string>();
            var r = color.R / 255f;
            var g = color.G / 255f;
        ...
        private void AddXmlChild(XmlDocument doc, XmlElement parent, string elementName, Blend blendFunction)
        {
            int value = 0;
        ...
        private void AddXmlChild(XmlDocument doc, XmlElement parent, string elementName, ParticleEmitterType emitterType)
        {
            int value = 0;
        ...
        private void AddXmlChild(XmlDocument doc, XmlElement parent, string elementName, Sprite texture)
        {
        ...
        private void AddXmlChild(XmlDocument doc, XmlElement parent, string elementName, Dictionary<string, string> attributes)
        {
