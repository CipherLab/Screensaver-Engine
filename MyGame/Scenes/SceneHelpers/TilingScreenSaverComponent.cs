...
namespace ScreenSaverEngine2.Scenes.SceneHelpers
{
    public class TilingScreenSaverComponent : Component, IUpdatable
    {
        ...
        public Phase CurrentPhase { get; set; } = Phase.GetImage;
        ...
        private int alphaIncr = 3;
        public int mAlphaValue = 255;
        private double mFadeDelay = 0;
        private float fadeDelay = .055f;

        #endregion fade stuff
        ...
        public event EventHandler<TilingSaverPhaseChangeEventArgs> PhaseChangedEvent;

        protected virtual void OnPhaseChanged(TilingSaverPhaseChangeEventArgs e)
        {
            if (PhaseChangedEvent != null)
            {
                PhaseChangedEvent(null, e);
            }
        }

        public TilingScreenSaverComponent(GraphicsDevice graphicsDevice, ISimpleImageHelper simpleImageHelper)
        {
            SimpleImageHelper = simpleImageHelper;
        ...
        public ISimpleImageHelper SimpleImageHelper { get; set; }
        ...
        {
            _loadingImage = true;
            byte[] image = SimpleImageHelper.MirrorUpconvertImage(
