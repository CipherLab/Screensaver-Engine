...
using ScreenSaverHelper.Enums;

namespace ScreenSaverHelper.Util
{
    public class ImageUnpacker
    {
        public int DistanceBetweenTiles = 3;
        ...
        public ImageUnpacker(Image image, byte[] imageData, bool removeTransparency, int distanceBetweenTiles)
        {
        ...
        public static List<Rectangle> OrderBoxes(List<Rectangle> boxes, SelectAllOrder selectAllOrder, Size spriteSheetSize)
        {
        ...
        private void HandleDividedArea(Rectangle region, bool updateCounter, Bitmap image)
        {
            ...
            {
                using (RegionUnpacker unpacker = new RegionUnpacker(image, region, this.backgroundColour.Value, DistanceBetweenTiles))
                {
